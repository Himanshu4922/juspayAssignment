...
export default function TotalSalesChart({ totalSalesData }) {
  ...
  useEffect(() => {
    const resize = () => {
      ...
      setSize(Math.min(180, Math.max(140, width - 40)));
    };
  ...
  const onMove = (e) => {
    setTooltip((t) =>
      t.visible ? { ...t, clientX: e.clientX, clientY: e.clientY } : t
    );
  };
  ...
  const totalSalesValue = totalSalesData.reduce(
  ...
  return (
    <div ref={containerRef} className="w-full flex justify-center items-center">
      <svg
        width={width > 640 ? 120 : size}
        height={width > 640 ? 120 : size}
        viewBox="0 0 120 120"
      ...
      >
        <path
          ...
          onMouseEnter={(e) => onEnter(e, totalSalesData[0])}
          onMouseMove={onMove}
        ...
        <path
          ...
          fill={"#95A4FC"}
          onMouseEnter={(e) => onEnter(e, totalSalesData[1])}
          onMouseMove={onMove}
          onMouseLeave={onLeave}
        />
        ...
        <path
          ...
          fill={"#B1E3FF"}
          onMouseEnter={(e) => onEnter(e, totalSalesData[2])}
          onMouseMove={onMove}
          onMouseLeave={onLeave}
        />
        ...
        <path
          ...
          fill={"#baedbd"}
          onMouseEnter={(e) => onEnter(e, totalSalesData[3])}
          onMouseMove={onMove}
          onMouseLeave={onLeave}
        />
      </svg>
